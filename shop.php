...
$m=$_REQUEST['m'];
$s=$_REQUEST['s'];
	$qq3=mysqli_query($dhy,"select *from products where m_name='$m' and sub_cate_nm='$s' order by pid desc")or die("Qfd");
while($data5=mysqli_fetch_array($qq3))
{
?>
                                        ...
                                        <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="product_photos/<?php echo $data5['photo1'];?>" class="img-fluid" alt="Image">
                                                     
                                                </div>
                                                <div class="why-text">
                                                    <h4><?php echo $data5['sub_cate_nm'];?></h4>
                                                    <h5> &#8377;<?php echo $data5['s_price'];?></h5>
<a href="shop_detail.php?p=<?php echo $data5['pid'];?>">More Details</a>
                                                </div>
                                            </div>
                                        </div>
<?php 
