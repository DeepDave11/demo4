...
<body>
	...
	<?php 
		...
		while($data12=mysqli_fetch_array($qw))
		{
		
?>

                                	  <td class="thumbnail-img">
                                        <img src="product_photos/<?php echo $data12['photo1'];?>" height="100" width="100">
                                    </td>
                                    <td class="name-pr">
                                       <?PHP echo $data12['m_name']." - ".$data12['company_brand'];?>
                                    </td>
                                    <td class="price-pr">
                                      <?php echo $data12['s_price'];?> 
                                    </td>
